...
# icon
icon_image = PhotoImage(file="E:\\book_recommendation_system\\Images\\icon1.png")
root.iconphoto(False, icon_image)

# background image
heading_image = PhotoImage(file="E:\\book_recommendation_system\\Images\\background1.png")
Label(root, image=heading_image, bg="#111119").place(x=-2, y=-2)

# logo
logo_image = PhotoImage(file="E:\\book_recommendation_system\\Images\\logo1.png")
...
search_box = PhotoImage(file="E:\\book_recommendation_system\\Images\\Rectangle 21.png")
...
# search button
recommend_button_image = PhotoImage(file="E:\\book_recommendation_system\\Images\\Search1.png")
...
# refresh button
Refresh_image = PhotoImage(file="E:\\book_recommendation_system\\Images\\refresh1.png")
...
# setting button
Setting_image = PhotoImage(file="E:\\book_recommendation_system\\Images\\setting1.png")
...
# logout button
Logout_image = PhotoImage(file="E:\\book_recommendation_system\\Images\\logout1.png")
